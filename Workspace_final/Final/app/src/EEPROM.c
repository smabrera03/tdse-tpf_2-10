...
uint16_t bytestowrite(uint16_t size, uint16_t offset) {//Esta es una función auxiliar necesaria para las demás.
...
void EEPROM_Write (uint16_t page, uint16_t offset, uint8_t *data, uint16_t size){
    /*Primero, que son estos parámetros
    ...
    */
    ...
    for (int i=0; i<numofpages; i++){
        ...
        */
        ...
        //Este delay lo comenté para no tener que esperar.
